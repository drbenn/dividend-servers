...
def get_annual_financials(connection, ticker) -> list[object]:
...
def get_historic_dividends_from_fmp(connection, ticker) -> any:
...
def get_company_profiles_and_update_db(connection, ticker) -> any:
  try:
...
def get_basic_financials_hi_low_beta_and_update_db(connection, ticker) -> any:
