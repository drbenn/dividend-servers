...
def calculate_current_dividend_yield(ticker, historic_dividends, dividend_payment_months_and_counts) -> float:
  current_quote = db_fin_api_calls.get_current_price_quote(ticker)
...
def calculate_payout_ratios(annual_financials, annual_dividends, ticker)  -> str:
  ...
  annual_payout_ratios = build_annual_payout_ratios(annual_financials, annual_dividends, ticker)
